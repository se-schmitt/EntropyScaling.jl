...
function ChapmanEnskogModel(comps::AbstractVector, σ::Vector{T}, ε::Vector{T}, Mw::Vector{T}; collision_integral=KimMonroe()) where {T} 
...
function ChapmanEnskogModel(comps::AbstractVector; Mw=[], ref="", ref_id="", collision_integral=KimMonroe())
